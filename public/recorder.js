...
async function openGallery() {
  ...
  if (!g) { g = document.createElement('div'); g.id = 'airGallery'; g.innerHTML = `<div class="gw"><div class="gt"><span>AIRMASK · sessions</span><button id="airGalX">✕ close</button></div><div class="gg" id="airGG"></div><div class="gm" id="airGM"></div></div>`; document.body.appendChild(g); g.querySelector('#airGalX').onclick = () => g.remove(); }
