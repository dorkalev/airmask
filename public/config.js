...
// just the avatar (the recording layer turns itself off). To enable the shared
// gallery, drop in your OWN Firebase web config below, point ADMIN_EMAIL at your
// account (it gates admin.html), and set DEMO to a namespace for this app's
// clips. These are client-side identifiers, safe to ship — real protection is
// the Storage rules + App Check. (This deploy uses Dor Kalev's.)
